...
GLOBAL_STRING_6 DB "The fibonachi value is", 0DH, 0AH, '$'
GLOBAL_STRING_7 DB "Prime Function ", 0DH, 0AH, '$'
GLOBAL_STRING_8 DB "Enter Number to find if he is prime ", 0DH, 0AH, '$'
GLOBAL_STRING_9 DB "Number Is Prime!", 0DH, 0AH, '$'
GLOBAL_STRING_10 DB "Number Is Not Prime!", 0DH, 0AH, '$'
GLOBAL_STRING_11 DB "Even Function ", 0DH, 0AH, '$'
GLOBAL_STRING_12 DB "enter a number to find if hes even ", 0DH, 0AH, '$'
GLOBAL_STRING_13 DB "number is even", 0DH, 0AH, '$'
GLOBAL_STRING_14 DB "number is not even", 0DH, 0AH, '$'
